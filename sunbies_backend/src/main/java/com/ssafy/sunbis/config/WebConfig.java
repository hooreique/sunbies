...
import com.ssafy.sunbis.interceptor.JwtInterceptor;

@Configuration
public class WebConfig implements WebMvcConfigurer {

	private static final String[] EXCLUDE_PATHS = { "/swagger-ui/**", "/member/**", "/error/**" };
...
////		registry.addInterceptor(jwtInterceptor).addPathPatterns("/member/**", "/article/**", "/memo/**") // 기본 적용 경로
